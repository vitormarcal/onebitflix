...
# Featured Movie
movie1 = Movie.create(title: "Ruby On Rails Api do zero ao Deploy", description: "Aprenda a criar uma API completa com Ruby On Rails...", thumbnail_key: "rails-api1.jpg", thumbnail_cover_key: "rails-api-cover.jpg", video_key: "rails-api1.mp4", highlighted: true, category: ror, featured_thumbnail_key: "rails-api-featured.jpg")
...
# Movies sem série
movie2 = Movie.create(title: "Crie generators no Ruby On Rails", description: "Generators são uma maneira de você automatizar a criação de conjuntos de arquivos no seu APP (assim como o rails new, o rails generate controller, o rails generate scaffold e etc), e nesse Screencast nós vamos aprender como cria-los..", thumbnail_key: "generators.jpg", thumbnail_cover_key: "generators-cover.jpg", video_key: "generators.mp4", category: ror)
movie3 = Movie.create(title: "Dominando o uso de Jobs no RoR - Parte 1", description: "s Jobs são uma maneira fácil de você rodar processos demorados em background (evitando lentidão na hora de responder as requisições do usuário e tornando seu sistema mais fluido).", thumbnail_key: "jobs1.jpg", thumbnail_cover_key: "jobs1-cover.jpg", video_key: "jobs1.mp4", category: ror)
movie4 = Movie.create(title: "Dominando o uso de Jobs no RoR - Parte 2", description: "s Jobs são uma maneira fácil de você rodar processos demorados em background (evitando lentidão na hora de responder as requisições do usuário e tornando seu sistema mais fluido).", thumbnail_key: "jobs2.jpg", thumbnail_cover_key: "jobs2-cover.jpg", video_key: "jobs2.mp4", category: ror)
movie5 = Movie.create(title: "Instalando pacotes no Rails com Yarn", description: "O Yarn é um gerenciador de pacotes javascript rápido, seguro e confiável que foi integrado no rails >= 5.1 para facilitar ainda mais a gestão das dependências. (agora você usa o Bundler para bibliotecas ruby e o Yarn para bibliotecas javascript, simples assim)", thumbnail_key: "materialize.jpg", thumbnail_cover_key: "materialize-cover.jpg", video_key: "materialize.mp4", category: ror)

movie5 = Movie.create(title: "Como monitorar seu APP em produção", description: "Hoje vamos falar de um tema muito interessante quando precisamos lidar com a verificação da saúde do nosso ambiente de produção: a instrumentação.", thumbnail_key: "obt18.jpg", thumbnail_cover_key: "obt18-cover.jpg", video_key: "obt18.mp4", category: outros)
movie6 = Movie.create(title: "Desmistificando a Criação de APIs", description: "Desmistificando a Criação de APIs Desmistificando a Criação de APIs Desmistificando a Criação de APIs Desmistificando a Criação de APIs", thumbnail_key: "obt17.jpg", thumbnail_cover_key: "obt17-cover.jpg", video_key: "obt17.mp4", category: outros)
movie7 = Movie.create(title: "Dominando o Visual Studio Code - Parte 1", description: "O Visual Studio Code é um editor de texto Open Source completo que possui integração nativa com o Git, milhares de extensões, é rápido e permite que você realize o debug facilmente do seu código.", thumbnail_key: "vscode1.jpg", thumbnail_cover_key: "vscode1-cover.jpg", video_key: "vscode1.mp4", category: outros)
movie8 = Movie.create(title: "Dominando o Visual Studio Code - Parte 1", description: "O Visual Studio Code é um editor de texto Open Source completo que possui integração nativa com o Git, milhares de extensões, é rápido e permite que você realize o debug facilmente do seu código.", thumbnail_key: "vscode2.jpg", thumbnail_cover_key: "vscode2-cover.jpg", video_key: "vscode2.mp4", category: outros)
movie9 = Movie.create(title: "Dominando o Visual Studio Code - Parte 1", description: "O Visual Studio Code é um editor de texto Open Source completo que possui integração nativa com o Git, milhares de extensões, é rápido e permite que você realize o debug facilmente do seu código.", thumbnail_key: "vscode3.jpg", thumbnail_cover_key: "vscode3-cover.jpg", video_key: "vscode3.mp4", category: outros)


# Series
vscode = Serie.create(title: 'Visual Studio Code', description: 'Uma série completa para você dominar um dos mais importantes editores de texto', thumbnail_key: "vscode1.jpg", thumbnail_cover_key: "vscode-serie-cover.jpg", category: outros)
movie10 = Movie.create(title: "Dominando o Visual Studio Code - Parte 1", description: "O Visual Studio Code é um editor de texto Open Source completo que possui integração nativa com o Git, milhares de extensões, é rápido e permite que você realize o debug facilmente do seu código.", thumbnail_key: "vscode1.jpg", thumbnail_cover_key: "vscode1-cover.jpg", video_key: "vscode1.mp4", serie: vscode, episode_number: 1)
movie11 = Movie.create(title: "Dominando o Visual Studio Code - Parte 2", description: "O Visual Studio Code é um editor de texto Open Source completo que possui integração nativa com o Git, milhares de extensões, é rápido e permite que você realize o debug facilmente do seu código.", thumbnail_key: "vscode2.jpg", thumbnail_cover_key: "vscode2-cover.jpg", video_key: "vscode2.mp4", serie: vscode, episode_number: 2)
movie12 = Movie.create(title: "Dominando o Visual Studio Code - Parte 3", description: "O Visual Studio Code é um editor de texto Open Source completo que possui integração nativa com o Git, milhares de extensões, é rápido e permite que você realize o debug facilmente do seu código.", thumbnail_key: "vscode3.jpg", thumbnail_cover_key: "vscode3-cover.jpg", video_key: "vscode3.mp4", serie: vscode, episode_number: 3)
